...
INSERT INTO orders_products VALUES (1, 1, 1, 1, DEFAULT, DEFAULT);
SELECT * FROM orders;
SELECT * FROM orders_products;
SELECT * FROM users WHERE id = (SELECT user_id FROM orders);
INSERT INTO orders(user_id) VALUES (2);
INSERT INTO orders_products VALUES (2, 2, 2, 2, DEFAULT, DEFAULT);
SELECT * FROM orders;
SELECT * FROM orders_products;
...
SELECT id, name, description, price, (SELECT name FROM catalogs WHERE id = catalog_id) AS catalogs FROM products;
...
SELECT id, 
(SELECT name FROM cities WHERE label = flights.`from`) AS 'Вылет', 
(SELECT name FROM cities WHERE label = flights.`to`) AS 'Прилет'
FROM flights;